...
const handleGetStore = () => {
  ...
  createHiddenInput(form, "ServerReplyURL", "http://localhost:3000/cart");
...
class Test extends Component {
  state = {};
  render() {
    return <React.Fragment>{handleGetStore()}
        <div className="btn btn-info ms-3 me-3 p-1 cartFontSize" onClick={()=>{send()}}>取得地址</div>
    </React.Fragment>;
  }
  componentDidMount() {}
}
